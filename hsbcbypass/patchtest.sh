...
SSH="ssh -p 22215 -o StrictHostKeyChecking=no -o ConnectTimeout=6 mobile@localhost"
...
scp -P 22215 -o StrictHostKeyChecking=no "$WORK" mobile@localhost:/tmp/hsbcchinax.patched >/dev/null || { echo "scp 失败"; exit 1; }

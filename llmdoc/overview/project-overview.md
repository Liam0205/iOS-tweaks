...
MYBankBypass 是一个基于 Theos 的 iOS 越狱检测绕过 tweak，目标 App 为网商银行 `com.mybank.ios.phone`，当前已知适配版本为 `4.6.4`。项目的主要目的，是让目标 App 在已越狱设备上正常启动并保持可用，而不是做通用 Hook 框架或多 App 兼容产品。
